    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (navHostFragment != null) {
            ...
            navController.addOnDestinationChangedListener((controller, destination, arguments) -> {
                ...
                // Back arrow
                if (destination.getId() == R.id.fragment_create_account || destination.getId() == R.id.fragment_email_recup || destination.getId() == R.id.fragment_email_recup_code || destination.getId() == R.id.fragment_password_recup || destination.getId() == R.id.profileFragment || destination.getId() == R.id.createScheduleFragment || destination.getId() == R.id.addPetsFragment || destination.getId() == R.id.modifyPetsFragment || destination.getId() == R.id.listPetsFragment) {
                    // Sinon, affichez le LinearLayout
